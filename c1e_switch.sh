...
for lastPcpuEachPackage in $(seq $((${numPcpus} / ${numPackages} - 1)) $((${numPcpus} / ${numPackages})) ${numPcpus})
do
    echo -e "writing ${switchedC1eMsr} to PCPU ${lastPcpuEachPackage} at ${MSR_POWER_CTL}"
